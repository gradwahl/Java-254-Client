...
public class Pix3D extends Pix2D {
	...
	/** Non-null when the GPU renderer is active; intercepts all triangle calls. */
	public static TriangleRenderer glRenderer = null;

	/** View-space Z for the 3 vertices of the next triangle. Set by Model before each draw call. */
	public static int triZ0, triZ1, triZ2;
	...
	public static void init() {
		...
		for (int var2 = 0; var2 < Pix2D.height; var2++) {
			scanline[var2] = Pix2D.width * var2;
		}
		projectionX = Pix2D.width / 2;
		projectionY = Pix2D.height / 2;
	}

	@ObfuscatedName("ib.a(III)V")
	public static void initWH(int arg0, int arg2) {
	...
	public static int getAverageTextureRgb(int arg1) {
		...
		averageTextureRgb[arg1] = var8;
		return var8;
	}

	@ObfuscatedName("ib.c(II)V")
	public static void pushTexture(int arg1) {
		if (activeTexels[arg1] != null) {
			texelPool[poolSize++] = activeTexels[arg1];
			activeTexels[arg1] = null;
		}
	}
	...
	public static int[] getTexels(int arg0) {
		...
		if (lowMem) {
			...
			for (int var7 = 0; var7 < 4096; var7++) {
				int var8 = var1[var7] = var6[var5.data[var7]] & 0xF8F8FF;
				if (var8 == 0) {
			...
			if (var5.wi == 64) {
				for (int var9 = 0; var9 < 128; var9++) {
					for (int var10 = 0; var10 < 128; var10++) {
						var1[var10 + (var9 << 7)] = var6[var5.data[(var10 >> 1) + (var9 >> 1 << 6)]];
					}
				}
			} else {
				for (int var11 = 0; var11 < 16384; var11++) {
					var1[var11] = var6[var5.data[var11]];
				}
			}
			textureTranslucent[arg0] = false;
		...
		for (int var7 = 0; var7 < 512; var7++) {
			...
			for (int var12 = 0; var12 < 128; var12++) {
				...
				if (var10 != 0.0D) {
					double var21;
					if (var13 < 0.5D) {
						var21 = var13 * (var10 + 1.0D);
					} else {
						var21 = var13 + var10 - var13 * var10;
					}
					...
					if (var25 * 6.0D < 1.0D) {
						var15 = var23 + (var21 - var23) * 6.0D * var25;
					} else if (var25 * 2.0D < 1.0D) {
						var15 = var21;
					} else if (var25 * 3.0D < 2.0D) {
						var15 = var23 + (var21 - var23) * (0.6666666666666666D - var25) * 6.0D;
					} else {
						var15 = var23;
					}
					if (var8 * 6.0D < 1.0D) {
						var17 = var23 + (var21 - var23) * 6.0D * var8;
					} else if (var8 * 2.0D < 1.0D) {
						var17 = var21;
					} else if (var8 * 3.0D < 2.0D) {
						var17 = var23 + (var21 - var23) * (0.6666666666666666D - var8) * 6.0D;
					} else {
						var17 = var23;
					}
					if (var29 * 6.0D < 1.0D) {
						var19 = var23 + (var21 - var23) * 6.0D * var29;
					} else if (var29 * 2.0D < 1.0D) {
						var19 = var21;
					} else if (var29 * 3.0D < 2.0D) {
						var19 = var23 + (var21 - var23) * (0.6666666666666666D - var29) * 6.0D;
					} else {
						var19 = var23;
					}
				}
				...
				int var35 = gammaCorrect(var34, var3);
		...
		for (int var36 = 0; var36 < 50; var36++) {
			if (textures[var36] != null) {
				...
				for (int var38 = 0; var38 < var37.length; var38++) {
					texturePalette[var36][var38] = gammaCorrect(var37[var38], var3);
				}
			}
		}
	...
	public static void gouraudTriangle(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
		if (glRenderer != null && Pix2D.pixels == com.gradwahl.rs254.gl.GLRenderer.viewportPixels) {
			glRenderer.addGouraud(arg3, arg0, arg4, arg1, arg5, arg2, arg6, arg7, arg8, trans, triZ0, triZ1, triZ2);
			return;
		}
		int var9 = 0;
		int var10 = 0;
						...
						while (true) {
							...
							if (var22 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var23, 0, 0, var16 >> 16, var19 >> 16, var18 >> 7, var20 >> 7);
									var16 += var13;
									var19 += var11;
									var18 += var14;
									var20 += var12;
							...
							gouraudRaster(Pix2D.pixels, var23, 0, 0, var16 >> 16, var15 >> 16, var18 >> 7, var17 >> 7);
							var16 += var13;
							var15 += var9;
							var18 += var14;
							var17 += var10;
						...
						while (true) {
							...
							if (var25 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var26, 0, 0, var19 >> 16, var16 >> 16, var20 >> 7, var18 >> 7);
									var16 += var13;
									var19 += var11;
									var18 += var14;
									var20 += var12;
							...
							gouraudRaster(Pix2D.pixels, var26, 0, 0, var15 >> 16, var16 >> 16, var17 >> 7, var18 >> 7);
							var16 += var13;
							var15 += var9;
							var18 += var14;
							var17 += var10;
						...
						while (true) {
							...
							if (var34 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var35, 0, 0, var31 >> 16, var27 >> 16, var32 >> 7, var29 >> 7);
									var31 += var11;
									var27 += var9;
									var32 += var12;
									var29 += var10;
							...
							gouraudRaster(Pix2D.pixels, var35, 0, 0, var28 >> 16, var27 >> 16, var30 >> 7, var29 >> 7);
							var28 += var13;
							var27 += var9;
							var30 += var14;
							var29 += var10;
						...
						while (true) {
							...
							if (var37 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var38, 0, 0, var27 >> 16, var31 >> 16, var29 >> 7, var32 >> 7);
									var31 += var11;
									var27 += var9;
									var32 += var12;
									var29 += var10;
							...
							gouraudRaster(Pix2D.pixels, var38, 0, 0, var27 >> 16, var28 >> 16, var29 >> 7, var30 >> 7);
							var28 += var13;
							var27 += var9;
							var30 += var14;
							var29 += var10;
						...
						while (true) {
							...
							if (var46 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var47, 0, 0, var40 >> 16, var43 >> 16, var42 >> 7, var44 >> 7);
									var40 += var9;
									var43 += var13;
									var42 += var10;
									var44 += var14;
							...
							gouraudRaster(Pix2D.pixels, var47, 0, 0, var40 >> 16, var39 >> 16, var42 >> 7, var41 >> 7);
							var40 += var9;
							var39 += var11;
							var42 += var10;
							var41 += var12;
						...
						while (true) {
							...
							if (var49 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var50, 0, 0, var43 >> 16, var40 >> 16, var44 >> 7, var42 >> 7);
									var40 += var9;
									var43 += var13;
									var42 += var10;
									var44 += var14;
							...
							gouraudRaster(Pix2D.pixels, var50, 0, 0, var39 >> 16, var40 >> 16, var41 >> 7, var42 >> 7);
							var40 += var9;
							var39 += var11;
							var42 += var10;
							var41 += var12;
						...
						while (true) {
							...
							if (var58 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var59, 0, 0, var55 >> 16, var51 >> 16, var56 >> 7, var53 >> 7);
									var55 += var13;
									var51 += var11;
									var56 += var14;
									var53 += var12;
							...
							gouraudRaster(Pix2D.pixels, var59, 0, 0, var52 >> 16, var51 >> 16, var54 >> 7, var53 >> 7);
							var52 += var9;
							var51 += var11;
							var54 += var10;
							var53 += var12;
						...
						while (true) {
							...
							if (var61 < 0) {
								while (true) {
									...
									gouraudRaster(Pix2D.pixels, var62, 0, 0, var51 >> 16, var55 >> 16, var53 >> 7, var56 >> 7);
									var55 += var13;
									var51 += var11;
									var56 += var14;
									var53 += var12;
							...
							gouraudRaster(Pix2D.pixels, var62, 0, 0, var51 >> 16, var52 >> 16, var53 >> 7, var54 >> 7);
							var52 += var9;
							var51 += var11;
							var54 += var10;
							var53 += var12;
					...
					while (true) {
						...
						if (var70 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var71, 0, 0, var64 >> 16, var67 >> 16, var66 >> 7, var68 >> 7);
								var64 += var11;
								var67 += var9;
								var66 += var12;
								var68 += var10;
						...
						gouraudRaster(Pix2D.pixels, var71, 0, 0, var64 >> 16, var63 >> 16, var66 >> 7, var65 >> 7);
						var64 += var11;
						var63 += var13;
						var66 += var12;
						var65 += var14;
					...
					while (true) {
						...
						if (var73 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var74, 0, 0, var67 >> 16, var64 >> 16, var68 >> 7, var66 >> 7);
								var64 += var11;
								var67 += var9;
								var66 += var12;
								var68 += var10;
						...
						gouraudRaster(Pix2D.pixels, var74, 0, 0, var63 >> 16, var64 >> 16, var65 >> 7, var66 >> 7);
						var64 += var11;
						var63 += var13;
						var66 += var12;
						var65 += var14;
					...
					while (true) {
						...
						if (var82 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var83, 0, 0, var79 >> 16, var75 >> 16, var80 >> 7, var77 >> 7);
								var79 += var9;
								var75 += var13;
								var80 += var10;
								var77 += var14;
						...
						gouraudRaster(Pix2D.pixels, var83, 0, 0, var76 >> 16, var75 >> 16, var78 >> 7, var77 >> 7);
						var76 += var11;
						var75 += var13;
						var78 += var12;
						var77 += var14;
					...
					while (true) {
						...
						if (var85 < 0) {
							while (true) {
								...
								gouraudRaster(Pix2D.pixels, var86, 0, 0, var75 >> 16, var79 >> 16, var77 >> 7, var80 >> 7);
								var79 += var9;
								var75 += var13;
								var80 += var10;
								var77 += var14;
						...
						gouraudRaster(Pix2D.pixels, var86, 0, 0, var75 >> 16, var76 >> 16, var77 >> 7, var78 >> 7);
						var76 += var11;
						var75 += var13;
						var78 += var12;
						var77 += var14;
	...
	public static void flatTriangle(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		if (glRenderer != null && Pix2D.pixels == com.gradwahl.rs254.gl.GLRenderer.viewportPixels) {
			glRenderer.addFlat(arg3, arg0, arg4, arg1, arg5, arg2, arg6, trans, triZ0, triZ1, triZ2);
			return;
		}
		int var7 = 0;
		if (arg1 != arg0) {
	...
	public static void textureTriangle(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18) {
		if (glRenderer != null && Pix2D.pixels == com.gradwahl.rs254.gl.GLRenderer.viewportPixels) {
			// Recompute the projective texture basis using long arithmetic to avoid
			// overflow: cross-products of view-space edge vectors involve (int*int)<<14
			// which overflows int for typical RS2 view-space coordinates (~±16000).
			int dX01 = arg9  - arg10, dX20 = arg11 - arg9;
			int dY01 = arg12 - arg13, dY20 = arg14 - arg12;
			int dZ01 = arg15 - arg16, dZ20 = arg17 - arg15;
			long uA = ((long)dX20 * arg12 - (long)dY20 * arg9)  << 14;
			long uB = ((long)dY20 * arg15 - (long)dZ20 * arg12) <<  8;
			long uC = ((long)dZ20 * arg9  - (long)dX20 * arg15) <<  5;
			long vA = ((long)dX01 * arg12 - (long)dY01 * arg9)  << 14;
			long vB = ((long)dY01 * arg15 - (long)dZ01 * arg12) <<  8;
			long vC = ((long)dZ01 * arg9  - (long)dX01 * arg15) <<  5;
			long wA = ((long)dY01 * dX20  - (long)dX01 * dY20)  << 14;
			long wB = ((long)dZ01 * dY20  - (long)dY01 * dZ20)  <<  8;
			long wC = ((long)dX01 * dZ20  - (long)dZ01 * dX20)  <<  5;
			// Evaluate the projective map at each screen vertex.
			// Within a scanline textureRaster uses (xstep >> 3) per pixel, so we mirror that.
			int dx0 = arg3 - projectionX, dy0 = arg0 - projectionY;
			long U0 = uA + uC * dy0 + (uB >> 3) * dx0;
			long V0 = vA + vC * dy0 + (vB >> 3) * dx0;
			long W0 = wA + wC * dy0 + (wB >> 3) * dx0;
			int dx1 = arg4 - projectionX, dy1 = arg1 - projectionY;
			long U1 = uA + uC * dy1 + (uB >> 3) * dx1;
			long V1 = vA + vC * dy1 + (vB >> 3) * dx1;
			long W1 = wA + wC * dy1 + (wB >> 3) * dx1;
			int dx2 = arg5 - projectionX, dy2 = arg2 - projectionY;
			long U2 = uA + uC * dy2 + (uB >> 3) * dx2;
			long V2 = vA + vC * dy2 + (vB >> 3) * dx2;
			long W2 = wA + wC * dy2 + (wB >> 3) * dx2;
			// U/W gives the normalised texture coordinate in [0,1] per cycle.
			float fu0 = W0 != 0 ? (float) U0 / W0 : 0f;
			float fv0 = W0 != 0 ? (float) V0 / W0 : 0f;
			float fu1 = W1 != 0 ? (float) U1 / W1 : 0f;
			float fv1 = W1 != 0 ? (float) V1 / W1 : 0f;
			float fu2 = W2 != 0 ? (float) U2 / W2 : 0f;
			float fv2 = W2 != 0 ? (float) V2 / W2 : 0f;
			glRenderer.addTextured(arg3, arg0, arg4, arg1, arg5, arg2,
					fu0, fv0, fu1, fv1, fu2, fv2,
					arg6, arg7, arg8, arg18, triZ0, triZ1, triZ2);
			return;
		}
						...
						while (true) {
							...
							if (var52 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var53, var42 >> 16, var45 >> 16, var44 >> 8, var46 >> 8, var48, var49, var50, var27, var30, var33);
									var42 += var39;
									var45 += var37;
									var44 += var40;
									var46 += var38;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var53, var42 >> 16, var41 >> 16, var44 >> 8, var43 >> 8, var48, var49, var50, var27, var30, var33);
							var42 += var39;
							var41 += var35;
							var44 += var40;
							var43 += var36;
						...
						while (true) {
							...
							if (var55 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var56, var45 >> 16, var42 >> 16, var46 >> 8, var44 >> 8, var48, var49, var50, var27, var30, var33);
									var42 += var39;
									var45 += var37;
									var44 += var40;
									var46 += var38;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var56, var41 >> 16, var42 >> 16, var43 >> 8, var44 >> 8, var48, var49, var50, var27, var30, var33);
							var42 += var39;
							var41 += var35;
							var44 += var40;
							var43 += var36;
						...
						while (true) {
							...
							if (var71 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var72, var57 >> 16, var61 >> 16, var59 >> 8, var62 >> 8, var64, var65, var66, var27, var30, var33);
									var61 += var37;
									var57 += var35;
									var62 += var38;
									var59 += var36;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var72, var57 >> 16, var58 >> 16, var59 >> 8, var60 >> 8, var64, var65, var66, var27, var30, var33);
							var58 += var39;
							var57 += var35;
							var60 += var40;
							var59 += var36;
						...
						while (true) {
							...
							if (var68 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var69, var61 >> 16, var57 >> 16, var62 >> 8, var59 >> 8, var64, var65, var66, var27, var30, var33);
									var61 += var37;
									var57 += var35;
									var62 += var38;
									var59 += var36;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var69, var58 >> 16, var57 >> 16, var60 >> 8, var59 >> 8, var64, var65, var66, var27, var30, var33);
							var58 += var39;
							var57 += var35;
							var60 += var40;
							var59 += var36;
						...
						while (true) {
							...
							if (var84 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var85, var74 >> 16, var77 >> 16, var76 >> 8, var78 >> 8, var80, var81, var82, var27, var30, var33);
									var74 += var35;
									var77 += var39;
									var76 += var36;
									var78 += var40;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var85, var74 >> 16, var73 >> 16, var76 >> 8, var75 >> 8, var80, var81, var82, var27, var30, var33);
							var74 += var35;
							var73 += var37;
							var76 += var36;
							var75 += var38;
						...
						while (true) {
							...
							if (var87 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var88, var77 >> 16, var74 >> 16, var78 >> 8, var76 >> 8, var80, var81, var82, var27, var30, var33);
									var74 += var35;
									var77 += var39;
									var76 += var36;
									var78 += var40;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var88, var73 >> 16, var74 >> 16, var75 >> 8, var76 >> 8, var80, var81, var82, var27, var30, var33);
							var74 += var35;
							var73 += var37;
							var76 += var36;
							var75 += var38;
						...
						while (true) {
							...
							if (var100 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var101, var93 >> 16, var89 >> 16, var94 >> 8, var91 >> 8, var96, var97, var98, var27, var30, var33);
									var93 += var39;
									var89 += var37;
									var94 += var40;
									var91 += var38;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var101, var90 >> 16, var89 >> 16, var92 >> 8, var91 >> 8, var96, var97, var98, var27, var30, var33);
							var90 += var35;
							var89 += var37;
							var92 += var36;
							var91 += var38;
						...
						while (true) {
							...
							if (var103 < 0) {
								while (true) {
									...
									textureRaster(Pix2D.pixels, var19, 0, 0, var104, var89 >> 16, var93 >> 16, var91 >> 8, var94 >> 8, var96, var97, var98, var27, var30, var33);
									var93 += var39;
									var89 += var37;
									var94 += var40;
									var91 += var38;
							...
							textureRaster(Pix2D.pixels, var19, 0, 0, var104, var89 >> 16, var90 >> 16, var91 >> 8, var92 >> 8, var96, var97, var98, var27, var30, var33);
							var90 += var35;
							var89 += var37;
							var92 += var36;
							var91 += var38;
					...
					while (true) {
						...
						if (var116 < 0) {
							while (true) {
								...
								textureRaster(Pix2D.pixels, var19, 0, 0, var117, var106 >> 16, var109 >> 16, var108 >> 8, var110 >> 8, var112, var113, var114, var27, var30, var33);
								var106 += var37;
								var109 += var35;
								var108 += var38;
								var110 += var36;
						...
						textureRaster(Pix2D.pixels, var19, 0, 0, var117, var106 >> 16, var105 >> 16, var108 >> 8, var107 >> 8, var112, var113, var114, var27, var30, var33);
						var106 += var37;
						var105 += var39;
						var108 += var38;
						var107 += var40;
					...
					while (true) {
						...
						if (var119 < 0) {
							while (true) {
								...
								textureRaster(Pix2D.pixels, var19, 0, 0, var120, var109 >> 16, var106 >> 16, var110 >> 8, var108 >> 8, var112, var113, var114, var27, var30, var33);
								var106 += var37;
								var109 += var35;
								var108 += var38;
								var110 += var36;
						...
						textureRaster(Pix2D.pixels, var19, 0, 0, var120, var105 >> 16, var106 >> 16, var107 >> 8, var108 >> 8, var112, var113, var114, var27, var30, var33);
						var106 += var37;
						var105 += var39;
						var108 += var38;
						var107 += var40;
					...
					while (true) {
						...
						if (var132 < 0) {
							while (true) {
								...
								textureRaster(Pix2D.pixels, var19, 0, 0, var133, var125 >> 16, var121 >> 16, var126 >> 8, var123 >> 8, var128, var129, var130, var27, var30, var33);
								var125 += var35;
								var121 += var39;
								var126 += var36;
								var123 += var40;
						...
						textureRaster(Pix2D.pixels, var19, 0, 0, var133, var122 >> 16, var121 >> 16, var124 >> 8, var123 >> 8, var128, var129, var130, var27, var30, var33);
						var122 += var37;
						var121 += var39;
						var124 += var38;
						var123 += var40;
					...
					while (true) {
						...
						if (var135 < 0) {
							while (true) {
								...
								textureRaster(Pix2D.pixels, var19, 0, 0, var136, var121 >> 16, var125 >> 16, var123 >> 8, var126 >> 8, var128, var129, var130, var27, var30, var33);
								var125 += var35;
								var121 += var39;
								var126 += var36;
								var123 += var40;
						...
						textureRaster(Pix2D.pixels, var19, 0, 0, var136, var121 >> 16, var122 >> 16, var123 >> 8, var124 >> 8, var128, var129, var130, var27, var30, var33);
						var122 += var37;
						var121 += var39;
						var124 += var38;
						var123 += var40;
