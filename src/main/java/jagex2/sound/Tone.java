...
public class Tone {
	...
	@ObfuscatedName("dc.l")
	public int[] hermonicSemitone = new int[5];
	...
	public int[] generate(int arg0, int arg1) {
		...
		for (int var12 = 0; var12 < 5; var12++) {
			if (this.harmonicVolume[var12] != 0) {
				...
				fMulti[var12] = (int) ((double) (this.frequencyBase.end - this.frequencyBase.start) * 32.768D * Math.pow(1.0057929410678534D, (double) this.hermonicSemitone[var12]) / var4);
		...
		for (int var13 = 0; var13 < arg0; var13++) {
			...
			if (this.frequencyModRate != null) {
				...
				var14 += this.waveFunc(this.frequencyModRate.form, var17, var8) >> 1;
				var8 += (var16 * var6 >> 16) + var7;
			}
			if (this.amplitudeModRate != null) {
				int var18 = this.amplitudeModRate.genNext(arg0);
				int var19 = this.amplitudeModRange.genNext(arg0);
				var15 = var15 * ((this.waveFunc(this.amplitudeModRate.form, var19, var11) >> 1) + 32768) >> 15;
			...
			for (int var20 = 0; var20 < 5; var20++) {
				if (this.harmonicVolume[var20] != 0) {
					...
					if (var21 < arg0) {
						buf[var21] += this.waveFunc(this.frequencyBase.form, var15 * fAmp[var20] >> 15, fPos[var20]);
	...
	public int waveFunc(int arg0, int arg2, int arg3) {
		if (arg0 == 1) {
			...
			return sine[arg3 & 0x7FFF] * arg2 >> 14;
		} else if (arg0 == 3) {
			return ((arg3 & 0x7FFF) * arg2 >> 14) - arg2;
		} else if (arg0 == 4) {
			return noise[arg3 / 2607 & 0x7FFF] * arg2;
		} else {
			return 0;
		}
	}
	...
	public void unpack(Packet arg1) {
		...
		for (int var6 = 0; var6 < 10; var6++) {
			...
			this.hermonicSemitone[var6] = arg1.gsmart();
